...
public class CalorieGraph {
	...
	String title, nameField, weightField, ageField;
	Boolean male;
	Integer activeLvl;
	HBox hBox;
	VBox layout;
	...
	public CalorieGraph(String title, String nameField, String weightField, 
			String ageField, boolean male, int activeLvl){
		this.title = title;
	...
	private void createButtons(){
		...
		resultsWindow= new ResultsWindow(table, calorieColumn, quantityColumn,
				DailyCalorieIntake(ageField, activeLvl, male), nameField);
	...
	public static int DailyCalorieIntake(String agefield, Integer activeLvl, boolean male){
